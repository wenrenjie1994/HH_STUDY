> 最新文档查阅：[https://github.com/DoubleLabyrinth/navicat-keygen](https://github.com/DoubleLabyrinth/navicat-keygen)
# Navicat Keygen - 如何使用这个注册机？ (Windows)

1. [从这里](http://server.while.cool:10000/database_tool/Navicat12%2BKeygen-Win-x64.zip)下载最新的release。
