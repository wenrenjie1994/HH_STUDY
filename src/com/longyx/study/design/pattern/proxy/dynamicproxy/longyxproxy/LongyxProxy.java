 ...
 */
public class LongyxProxy {
    private static final String line = "\r\n";

    public static Object newProxyInstance(LongyxClassLoader loader,
                                          Class<?>[] interfaces,
        ...
        try {
             ...
             * @return java.lang.Object
             */
            String filePath = com.longyx.study.design.pattern.proxy.dynamicproxy.longyxproxy.LongyxProxy.class.getResource("").getPath();
            ...
            Constructor c = proxyClass.getConstructor(LongyxInvocationHandler.class);
    ...
    private static String generateSrc(Class<?>[] interfaces) {
        ...
        sb.append("package com.longyx.study.design.pattern.proxy.dynamicproxy.longyxproxy;"+line);
        sb.append("import com.longyx.study.design.pattern.proxy.staticproxy.Person;"+line);
        sb.append("import java.lang.reflect.*;"+line);
        sb.append("public class $Proxy0 implements "+interfaces[0].getName()+"{"+line);
            sb.append("longyxInvocationHandler h;"+line);
            sb.append("public $Proxy0(longyxInvocationHandler h) {" + line);
