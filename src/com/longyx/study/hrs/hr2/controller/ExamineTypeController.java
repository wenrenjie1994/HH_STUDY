...
import com.longyx.study.hrs.hr2.dataobject.ExamineType;
import com.longyx.study.hrs.hr2.manager.ExamineTypeManager;
                ...
                if (ADD.equals(line)) {
                    ...
                    for (int i=0; i<examineTypeArrays.length;i++) {
                        ...
                        if ("examine_type_id".equals(values[0])) {
                            examineTypeId = Integer.parseInt(values[1]);
