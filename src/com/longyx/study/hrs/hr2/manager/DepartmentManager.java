package com.longyx.study.hrs.hr2.manager;

import com.longyx.study.hrs.hr2.dataobject.Department;
import com.longyx.study.hrs.hr2.util.DbUtil;
...
public class DepartmentManager {
     ...
     */
    private void deleteDepartments(Connection conn, int departmentId) throws SQLException {
        //先查询
        String sql = "select * from department where pid = ?";
        PreparedStatement ps = null;
        ResultSet rs = null;
     ...
     * @param departmentId
     */
    private void deleteDepartmentById(Connection conn, int departmentId) throws SQLException {
