...
import com.longyx.study.hrs.hr3.manager.DepartmentManager;
            ...
            while ((line = bufferedReader.readLine()) !=null) {
                ...
                if (ADD.equals(line)) {
                    ...
                    if (ADD.equals(state)) {
                        ...
                        int departmentId = Integer.valueOf(departmentArrays[0].split("=")[1].trim());
                        String departmentName = departmentArrays[1].split("=")[1];
