...
public class LowbHrSystem {
    ...
    void addInterviewee(){
        ...
        ReturnResult rr = operator.add(interviewee);
    ...
    void deleteByName(){
        ...
        ReturnResult rr = operator.deleteByName(interviewee);
        if(rr.isSuccess = true)
        {
    ...
    void deleteByID(){
        ...
        ReturnResult rr = operator.deleteByID(interviewee);
        if(rr.isSuccess = true)
        {
            System.out.println("删除面试者成功");
        }
    ...
    void modifyInterviewee(){
        ...
        String position=input.nextLine();
        Interviewee interviewee=new Interviewee(name,age,school,ID,position);
        ReturnResult rr = operator.modify(interviewee);
        if(rr.isSuccess = true){
    ...
    void findByName(){
        ...
        String name =input.nextLine();
        Interviewee interviewee=new Interviewee(name,0,null,null,null);
        ReturnResult rr = operator.searchByName(interviewee);
        IntervieweeList intervieweeList = (IntervieweeList)rr.resultData;
        int size = intervieweeList.size();
        if(size>0)
        {
    ...
    void findBySchool(){
        ...
        ReturnResult rr = operator.searchBySchool(interviewee);
        IntervieweeList intervieweeList = (IntervieweeList)rr.resultData;
        int size = intervieweeList.size();
        if(size>0)
        {
    ...
    void findByPosition(){
        ...
        ReturnResult rr = operator.searchByPosition(interviewee);
        IntervieweeList intervieweeList = (IntervieweeList)rr.resultData;
        int size = intervieweeList.size();
        if(size>0)
        {
