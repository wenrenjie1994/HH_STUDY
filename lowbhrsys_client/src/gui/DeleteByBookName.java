...
public class DeleteByBookName extends JFrame {
...
//        getContentPane().setCursor(cursor);
        ...
        bookNameField.setBounds(467, 168, 233, 50);
        ...
        AbstractAction delete=new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
				...
				ReturnResult rr=o.deleteBookByName(book);
				if(rr.isSuccess)
				{
