...
//        resume.setSchool(scanner.nextLine());
        ...
        int result = hrsService.updataResuem(resume,id);
        if (result >0){
    ...
    //查询简历
    public static void selectResume() {
        while(true) {
...
//        }
    ...
    private static void selectResumeBySchool() {
    ...
    private static void selectResumeByName() {
    ...
    private static void selectResumeById() {
    ...
    //所有简历
    public static void selectAllResume() {
        HRSService hrsService = new HRSService();
